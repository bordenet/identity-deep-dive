...
func (tkm *TenantKeyManager) GetJWKS(tenantID string) (*models.JWKSDocument, error) {
	...
	jwk := rsaPublicKeyToJWK(tenant.PublicKey, tenant.KeyID)
...
func parsePrivateKeyPEM(pemBytes []byte) (*rsa.PrivateKey, error) {
	...
	if block == nil {
		return nil, models.ErrPEMDecodeFailed
	}
...
func parsePublicKeyPEM(pemBytes []byte) (*rsa.PublicKey, error) {
	...
	if !ok {
		return nil, models.ErrNotRSAPublicKey
	}
...
func rsaPublicKeyToJWK(publicKey *rsa.PublicKey, keyID string) models.JWK {
